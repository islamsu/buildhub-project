...
import {
  ...
  UserCheck, UserX, Save, RefreshCw, ClipboardCheck, FileSearch, RotateCcw, XCircle, SendHorizontal, Download, CalendarDays, Loader2,
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const filteredRegistrationApplicants = useMemo(() => filterRegistrationApplicants(complianceQueue, { role: registrationRoleFilter, from: registrationDateFrom, to: registrationDateTo }), [complianceQueue, registrationRoleFilter, registrationDateFrom, registrationDateTo]);
  ...
  const exportRegistrationCsv = () => {
    ...
    toast.success(lang === 'ar' ? 'تم تصدير مؤشرات التسجيل' : 'Registration metrics exported');
  };
