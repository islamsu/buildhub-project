...
export default function AdminDashboard() {
  ...
  const adminSection = useMemo(() => {
    ...
    return ['users', 'projects', 'products', 'name-changes', 'referrals', 'placements', 'compliance', 'analytics', 'billing', 'disputes', 'operations', 'settings'].includes(section ?? '') ? section! : 'overview';
  }, [location]);
