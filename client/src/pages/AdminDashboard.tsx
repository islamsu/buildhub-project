...
export default function AdminDashboard() {
  ...
  const { data: disputes = [], isLoading: disputesLoading, isError: disputesFailed, refetch: refetchDisputes } =
    trpc.admin.disputes.useQuery(undefined, { enabled: can('support.manage') });
