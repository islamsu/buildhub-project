...
- [ ] ERROR-IS-NOT-EMPTY, last server-side item: `billing/service.ts:255`, a subscription state write that answers null rather than refusing, so a commercial mutation is silently skipped. Classified as DEBT and enforced.
